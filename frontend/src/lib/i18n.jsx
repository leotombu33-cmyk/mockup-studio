...
const dictionaries = {
  fr: {
    ...
    'studio.step1.sub': 'PNG, JPG ou WEBP — 25 Mo max',
    ...
    'upload.error.type': 'Format non pris en charge. Utilisez PNG, JPG ou WEBP.',
  ...
  en: {
    ...
    'studio.step1.sub': 'PNG, JPG or WEBP — 25 MB max',
    ...
    'upload.error.type': 'Unsupported format. Use PNG, JPG or WEBP.',
